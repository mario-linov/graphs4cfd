'''
    Script for training the AdvFourScaleGNN model on the AdvBox and AdvInBox datasets.
...
batch_transform = transforms.Compose([
    gfd.transforms.GridClustering([0.02, 0.04, 0.08]),
]) 
...
model = gfd.nn.AdvFourScaleGNN(arch=arch)
