'''
    Script for training the NsThreeGuillardScaleGNN model on the NsCircle dataset.
    This model is the three-scale GNN in Appendix C.3 in Lino et al. (2022) https://doi.org/10.1063/5.0097679.
'''
...
transform = transforms.Compose([
    gcfd.transforms.GuillardCoarseningAndConnectKNN(k=(6,6,6), period=(None,"auto"), scale_edge_attr=(0.1, 0.25, 0.5)),
...
model = gcfd.nn.NsThreeGuillardScaleGNN(arch=arch)
